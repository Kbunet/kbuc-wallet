...
import { HDSegwitBech32Wallet, HDSegwitP2SHWallet, LightningCustodianWallet, SegwitBech32Wallet, SegwitP2SHWallet } from '../../class';
...
const WalletsAdd: React.FC = () => {
  ...
  const toolTipActions = useMemo(() => {
    const walletSubactions: Action[] = [
      ...
      {
        id: SegwitBech32Wallet.type,
        text: `P2WPKH/Non-HD`,
        subtitle: 'p2wpkh/non-HD',
      ...
      <HeaderMenuButton
        onPressMenuItem={(id: string) => {
          ...
          if (id === HDSegwitBech32Wallet.type) {
            ...
            setSelectedIndex(2);
          } else if (id === SegwitBech32Wallet.type) {
            setSelectedIndex(3);
  ...
  const createWallet = async () => {
    ...
    if (selectedWalletType === ButtonSelected.OFFCHAIN) {
      ...
      let w: HDSegwitBech32Wallet | SegwitP2SHWallet | HDSegwitP2SHWallet | SegwitBech32Wallet;
      if (selectedIndex === 2) {
        ...
        // btc was selected
        // index 3 radio - segwit single address
